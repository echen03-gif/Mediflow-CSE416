...
const peopleData = [
  {
    ...
    imageUri: 'https://images.unsplash.com/photo-1500649708-c959990f5b44?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFybyx8fHx8ZW1wbG95ZWVkJTIwdXNlciUyMHByb2ZpbGVy&auto=format&fit=crop&w=600&q=60',
  },
  {
    id: 2,
    name: 'Dr. Mike Jones',
    message: 'Follow up appointment...',
    imageUri: 'https://images.unsplash.com/photo-1586283130344-dfe544944b2e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFybyx8fHxtdHJhYmFuJTIwdXNlciUyMHByb2ZpbGVy&auto=format&fit=crop&w=600&q=60',
  },
...
export default function Inbox() {
  ...
  const handleRowClick = (personId) => {
    navigation.navigate('ChatScreen', { personId });
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <DataTable style={styles.dataTable}>
        ...
        {paginatedPeople.map((person) => (
          <DataTable.Row key={person.id} onPress={() => handleRowClick(person.id)}>
            <DataTable.Cell>
              <Avatar.Image size={50} source={{ uri: person.imageUri }} />
            </DataTable.Cell>
        ...
        <DataTable.Pagination
          page={page}
          numberOfPages={Math.ceil(filteredPeople.length / rowsPerPage)}
